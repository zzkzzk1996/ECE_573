...
vector<vector<int>> FileReader::Reader() {
    ...
    try {
        ...
        vector<int> fileList = {1024, 2048, 4096, 8192, 16384, 32768};       ////this line you can keep it, it would be meaningless if you comment others
        // file name 1024, 2048, 4096, 8192, 16384, 32768
        for (int i = 0; i < fileList.size(); i++) {
            vector<int> data; // data container initialize
            string file = postFileName0 + to_string(fileList[i]);        ////for this part you can just comment this code snippet
